...
Let $\C \times \C \xrightarrow{\braket{\bullet \mid \star}} \C$ denote the standard complex inner product on $\C$ given by $\braket{z \mid w} = \overline{z} w$, which is linear in $w$.
...
\begin{align*}
	...
	n_z = z \cdot n
\end{align*}
Any triple of real numbers $\begin{pmatrix} n_x \\ n_y \\ n_z\end{pmatrix}$ uniquely determines the coordinate vector $n \in \R^3$ satisfying the above equations.
