...
\begin{align*}
	...
	= \sigma_z
\end{align*}
The Pauli operators $\sigma_x$ and $\sigma_z$ are hence symmetric, while $\sigma_y$ is antisymmetric.
...
\begin{proposition}
	The standard Pauli matrices satisfy the following equations.
	\begin{align*}
		\sigma_x \sigma_y =
		\begin{pmatrix}
			i & 0  \\
...
\begin{answer}[Spin along arbitrary direction after arbitrary measurement]
	...
	Suppose the apparatus is rotated to the $\hat{n}$ direction and then measured.
	...
	The unitary rotation $R$ associated to $r$ satisfies $\braket{m \mid n} = \braket{R m \mid R n } = \braket{u \mid R n}$.
