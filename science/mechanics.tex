...
\begin{answer}
	Calculation yields $\dsp \int_0^{\frac{\pi}{2}} x \cos x ~dx = \frac{\pi}{2}\sin \frac{\pi}{2} - \int_0^{\frac{\pi}{2}} \sin x ~dx$.
\end{answer}
...
\begin{answer}
	Integration yields $\dsp \int_0^t \dot{v_z} = \int_0^t \frac{F_z}{m}$.
\end{answer}
