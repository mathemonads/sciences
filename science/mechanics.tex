...
\begin{answer}
	...
	\begin{align}
		\dot{x}(t) & = -\omega A \sin \omega t + \omega B \sin \omega t
	\end{align}
\end{answer}
...
\begin{answer}
	...
	\begin{align*}
		...
		\end{pmatrix}
	\end{align*}
	The determinant of $H_1$ is $\op{Det} H_1 = \frac{\partial^2 F_1}{\partial x^2} \frac{\partial^2 F_1}{\partial y^2} - \frac{\partial^2 F_1}{\partial y \partial x}\frac{\partial^2 F_1}{\partial x \partial y} = \sin x \sin y - 0 \cdot 0$.
	The point $\dsp \left(\frac{\pi}{2}, -\frac{\pi}{2}\right)$ is a saddle point of $F_1$.
\end{answer}
