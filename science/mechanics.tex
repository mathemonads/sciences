...
\subsection{of Action}

\begin{answer}
	A particle with position $x$ in one dimension has kinetic energy $\dsp T = \frac{m}{2}\left(\dot{x} \cdot \dot{x}\right)$, Lagrangian $L = T - V$, and acceleration $a = \ddot{x}$.
\end{answer}
