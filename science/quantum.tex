...
\begin{answer}
	...
	\begin{align}
		...
		\end{pmatrix}
	\end{align}
	The characteristic polynomial $\det\p{\sigma_n - \lambda I} = \p{\cos \theta - \lambda}\p{- \cos \theta - \lambda} - \sin^2 \theta = \lambda^2 - 1^2$ yields eigenvalues $\lambda_1$ and $\lambda_2$.
\end{answer}
