...
\begin{answer}
	...
	The first bob has kinetic energy $T_1 = \frac{\dot{\theta}^2}{2}$, the second bob has kinetic energy $T_2 = \frac{\dot{\theta}^2 + \p{\dot{\theta} + \dot{\alpha}}^2}{2} + \dot{\theta} \left(\dot{\theta} + \dot{\alpha}\right) \cos \alpha$, the potential energy in the absence of gravity is $V = 0$, and the Lagrangian in the absence of gravity is $L = T_1 + T_2$. 
\end{answer}
