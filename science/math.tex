...
\begin{proposition}\label{prop:derivatives}
	For any generalized coordinate $q$ and canonical momentum $p = \frac{\partial L}{\partial \dot{q}}$, the units of the product $p q$ are $\left|p q\right| = \left|L\right| \left|t\right|$.
\end{proposition}
\begin{proof}
...
\begin{lemma}
	For any functions $F\left(\vq, \vp\right)$ and $G\left(\vq, \vp\right)$, the product of partial derivatives has the dimensions below.
	\begin{align*}
...
\end{lemma}
\begin{proof}
	The result follows from Remark \ref{rem:derivative} and Proposition \ref{prop:derivatives}.
\end{proof}
Observe they have the same units.
