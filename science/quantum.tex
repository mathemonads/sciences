...
\begin{lemma}[Product of spin operators]
	...
	\begin{align*}
		(\hat{m} \cdot \sigma)(\hat{n} \cdot \sigma) = \sum_{ij} m_i n_j \sigma_i \sigma_j
	\end{align*}
\end{lemma}
\begin{proof}
	The result is shown below.
	\begin{align*}
		(\hat{m} \cdot \sigma)(\hat{n} \cdot \sigma) = \sum_{ij} (m_i \sigma_i)(n_j \sigma_j) = \sum_{ij} m_i n_j \sigma_i \sigma_j
	\end{align*}
\end{proof}
