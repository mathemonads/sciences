...
Let $\R_{\geq 0} = [0, +\infty)$ denote the totally ordered commutative subsemiring of non-negative real numbers and $\N$ denote the totally ordered commutative subsemiring $\N \subseteq \R_{\geq 0}$ of natural numbers.
...
For any angular curve $\theta(t)$ for $\vr(t)$, the \emph{tangential curve} is the curve $\vth(t)$ such that $\vth(t_0)$ is perpendicular to $\vr(t_0)$ with the standard orientation and norm $\|\vth(t_0)\| = \|\vr(t_0)\|$.
