...
\begin{answer}
	...
	\begin{align}
		\frac{dz(t)}{dt} & = v_z(0) + \frac{F_z}{m}t
	\end{align}
\end{answer}
...
\begin{answer}
	...
	Behold.
	\begin{align*}
		\frac{\partial V_1}{\partial x} & = 2x - \cos xy &  & \frac{\partial V_1}{\partial y} = 2y - \cos xy &  & \frac{\partial^2 V_1}{\partial x \partial y} = 2 + \sin xy
	\end{align*}
\end{answer}
