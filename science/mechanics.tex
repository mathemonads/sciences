...
% chain rule
\begin{answer}[Potential energy inversely proportional to the square of the distance]
...
\begin{answer}
	...
	Since one of the terms in $L$ contains a factor of $\cos \alpha$, it follows that $\frac{\partial L}{\partial \alpha} \neq 0$ and thus $\dot{p_\alpha} \neq 0$.
...
\begin{answer}[Derivation of Newtonian mechanics from Poisson formulation]
