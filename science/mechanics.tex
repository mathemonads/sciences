...
\begin{answer}
	To determine the equation of motion for a simple pendulum of length $l$ and mass $m$ swinging through an arc in the $x,y$ plane from an initial angle of $\theta_0$, recall the Lagrangian given in Equation \ref{eqn:Lpend}.
	...
	The angular equation of motion is thus $m l^2 \ddot{\theta} + m g l \sin \theta = 0$ as obtained in Exercise \ref{ans:pendulum}.
\end{answer}
