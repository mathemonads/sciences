...
\begin{lemma}[Product of Pauli operators]
	...
	\begin{align*}
		...
		= \sum_{i, j} m_i n_j \delta_{ij} I + i \sum_{i, j} m_i n_j \sum_k \varepsilon_{ijk} \sigma_k
	\end{align*}
\end{lemma}
\begin{proof}
	The value $\dsp (\vec{m} \cdot \sigma)(\vec{n} \cdot \sigma) = \sum_{i,j} (m_i \sigma_i)(n_j \sigma_j) = \sum_{i,j} m_i n_j \sigma_i \sigma_j$ is given by Remark \ref{rem:Pauli} below.
	\begin{align*}
		\sum_{i, j} m_i n_j \p{\delta_{ij} I + i \sum_k \varepsilon_{ijk} \sigma_k}
		= \sum_{i, j} m_i n_j \delta_{ij} I + i \sum_{i, j} m_i n_j \sum_k \varepsilon_{ijk} \sigma_k
	\end{align*}
\end{proof}
...
\begin{answer}[Commutator of Hermitian operators]
	...
	Their commutator is given by $[M, L] = LM - ML$.
\end{answer}
