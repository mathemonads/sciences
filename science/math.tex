...
Let $\vq = \begin{pmatrix} q_1 \\ \vdots \\ q_i \\ \vdots \\ q_n \end{pmatrix}$ denote a vector of $n \in \N$ generalized coordinates, $\vp = \begin{pmatrix} p_1 \\ \vdots \\ p_i \\ \vdots \\ p_n \end{pmatrix}$ denote a vector of their canonical momenta, and let $L$ denote a Lagrangian.
