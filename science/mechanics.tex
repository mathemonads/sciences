...
\begin{answer}[Equation of motion of pendulum]
	To determine the equation of motion for a simple pendulum of constant mass $m \neq 0$ and length $l$ swinging through an arc in the $x,y$ plane from an initial angle of $\theta_0$, recall the Lagrangian given in Equation \eqref{eqn:Lpend}.
...
\begin{answer}[Change of variables in Lagrangian of harmonic oscillator]
	...
	\end{align}
	Calculation yields $x = \frac{q}{\p{k m}^{\frac{1}{4}}}$, $\dot{x} = \frac{\dot{q}}{\p{k m}^{\frac{1}{4}}}$, and $\dsp L = \frac{m}{2} \p{\frac{\dot{q}}{\p{k m}^{\frac{1}{4}}}}^2 - \frac{k}{2} \p{\frac{q}{\p{k m}^{\frac{1}{4}}}}^2$
...
\begin{answer}[Potential]
	The magnetic vector potential $A = \trans{\p{0, bx, 0}}$ yields the magnetic field $B = \vec{\nabla} \times A$ calculated below.
	\begin{align*}
		\begin{pmatrix}
			B_x \\
			B_y \\
