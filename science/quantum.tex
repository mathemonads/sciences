...
\begin{answer}
	...
	Then, the union $\dsp B_{n-1} \cup \left\{\frac{1}{\|\ket{\lambda_n}\|} \ket{\lambda_n} \right\}$ is an orthonormal basis of $H$ consisting of eigenvectors of $L$.
...
\begin{answer}
	...
	It follows from the second equation that $\p{\sigma_z}_{12} = 0$.
\end{answer}
