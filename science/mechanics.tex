...
\begin{answer}
	...
	\begin{align*}
		\frac{d}{dt}\left(f(t) g(t)\right)
		 ...
		 & = \lim_{\Delta t \to 0} \left[g(t+\Delta t)\frac{f(t+\Delta t) - f(t)}{\Delta t} + f(t) \frac{g(t+\Delta t) - g(t)}{\Delta t}\right] \\
...
\begin{answer}
	...
	Observe $\dsp \lim_{\Delta t \to 0} \frac{\sin \Delta t}{\cos \Delta t + 1} = \frac{0}{2} = 0$ and $\dsp \lim_{\Delta t \to 0} \frac{\cos \Delta t - 1}{\Delta t} = \lim_{\Delta t \to 0} \left[- \frac{\sin \Delta t}{\Delta t} \frac{\sin \Delta t}{\cos \Delta t + 1}\right] = 0$.
