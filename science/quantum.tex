...
\begin{align*}
	...
	= \sigma_z
\end{align*}
The Pauli matrices $\sigma_x$ and $\sigma_z$ are hence symmetric, while $\sigma_y$ is antisymmetric.

\begin{remark}[Conjugate transposes of the Pauli matrices]
	The conjugate transposes of the standard Pauli matrices are given below.
	\begin{align*}
		\sigma_x^\dagger =
		\begin{pmatrix}
			0 & 1 \\
...
For any unit vector $\hat{n} \in S^2$, the operator $\sigma_n$ satisfies the equations below.
\begin{align*}
	\sigma_n^2 & =
	\begin{pmatrix}
		n_z             & \p{n_x - i n_y} \\
...
\begin{proposition}
	For any rotation $r \in \op{SO}\p{3}$, there exists a unitary operator $R$ on spin-$\frac{1}{2}$ states such that any unit vector $\hat{n} \in \R^3$ satisfies
	\begin{align}
		R^\dagger \p{\sigma \cdot \hat{n}} R & = \sigma \cdot \p{r \cdot \hat{n}}
	\end{align}
	and any operator satisfying the above equation is either $R$ or $-R$.
\end{proposition}
